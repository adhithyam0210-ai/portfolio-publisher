              ...
              {experience.map((exp, idx) => (
                <div key={idx} className="tm-card">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '0.65rem' }}>
                    ...
                    <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', display: 'flex', alignItems: 'center', gap: '0.4rem', background: 'var(--tp-subtle, var(--bg-subtle))', padding: '0.25rem 0.6rem', borderRadius: '6px' }}>
                      <Calendar size={13} />
              ...
              {education.map((edu, idx) => (
                <div key={idx} className="tm-card">
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', marginBottom: '0.75rem' }}>
                    <div style={{ width: '38px', height: '38px', borderRadius: '10px', background: 'rgba(99, 102, 241, 0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--user-accent, var(--primary))' }}>
              ...
              <div className="tm-card">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
                  {certifications.map((cert, idx) => (
                    <div key={idx} style={{ paddingBottom: '0.85rem', borderBottom: idx < certifications.length - 1 ? '1px solid var(--tp-border, var(--border-subtle))' : 'none' }}>
              ...
              <div className="tm-card">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
                  {achievements.map((ach, idx) => (
                    <div key={idx} style={{ paddingBottom: '0.85rem', borderBottom: idx < achievements.length - 1 ? '1px solid var(--tp-border, var(--border-subtle))' : 'none' }}>
